            ...
            >
              ...
              <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                  ...
                  >
                    <Dialog.Panel
                      className={`w-1/3 transform overflow-hidden rounded-md
          ...
          <Dialog as="div" className="relative z-[99999]" onClose={onClose}>
            ...
            <div className="fixed inset-0 overflow-y-auto">
              ...
              >
                ...
                >
                  <Dialog.Panel
                    className={`w-1/3 transform overflow-y-auto overflow-x-hidden rounded-md
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll ${className}`}
                  >
                    <div
                      className={`relative overflow-auto py-2 px-3 text-white flex justify-between  ${themeClass}`}
                    >
                      <h4 className="capitalize leading-6 tracking-wider font-medium text-sm text-white">
                        {title}
                      </h4>
                    ...
                    {footerContent && (
                      <div className="px-3 py-2 flex justify-end space-x-3 border-t border-slate-100 dark:border-slate-700">
                        {footerContent}
                      </div>
                    )}
                  </Dialog.Panel>
